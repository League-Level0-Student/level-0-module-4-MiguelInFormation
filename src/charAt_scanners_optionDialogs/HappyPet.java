...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		//int task = JOptionPane.showOptionDialog(null, "WHAT WOULD YOU LIKE TO DO TO MAKE YOUR PET HAPPIER?", "HAPPY PET HAPPY LIFE", 0, JOptionPane.INFORMATION_MESSAGE, null, new String [] {"Feed it","Walk it","Scratch it"},null);
		 ...
		 while(true) {
				int task = JOptionPane.showOptionDialog(null, "WHAT WOULD YOU LIKE TO DO TO MAKE YOUR PET HAPPIER?", "HAPPY PET HAPPY LIFE", 0, JOptionPane.INFORMATION_MESSAGE, null, new String [] {"Feed it","Walk it","Scratch it","yes"},null);
